...
/**
 * @brief Sets QMX mode for CPU runtime.
 *
 * @param[in] snpeBuilderHandle Handle to access the SNPEBuilder object
 *
 * @param[in] cpuQmxMode Boolean If set to true, enables Qmx mode.
 *
 */
SNPE_API
Snpe_ErrorCode_t Snpe_SNPEBuilder_SetCpuQmxMode(
      Snpe_SNPEBuilder_Handle_t snpeBuilderHandle, bool cpuQmxMode);
